...
def parser():
    p = argparse.ArgumentParser(prog="levelupdiag", description="External Kristal deep-conformance diagnostics harness")
    p.add_argument("--target", help="Target Kristal repository root (default from levelupdiag.config.json: ../kristal-framework)")
